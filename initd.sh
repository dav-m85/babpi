...
USER="root"
APP_DIR="/home/pi/babpi"
NODE_APP="server.js"
CONFIG_DIR="$APP_DIR"
PID_DIR="$APP_DIR/pid"
PID_FILE="$PID_DIR/app.pid"
LOG_DIR="/var/log"
LOG_FILE="$LOG_DIR/babpi.log"
NODE_EXEC=$(which node)
APP_NAME="Babpi node server"
APP_ARGS="--port=80 --reverse --address=http://10.0.1.69"
...
start_it() {
    ...
    echo "cd $APP_DIR && $NODE_EXEC $APP_DIR/$NODE_APP $APP_ARGS 1>$LOG_FILE 2>&1 & echo \$! > $PID_FILE" | sudo -i -u $USER
