...
const socket = __webpack_require__(47)();
const jsonpatch = __webpack_require__(77);
...
module.exports = (WrappedComponent, initialState) => class RemoteStateSocket extends React.Component {
  ...
  render() {
    return React.createElement(WrappedComponent, _extends({ socket: socket }, this.state));
  }
};
...
/* export some helpers */
var helpers_2 = __webpack_require__(17);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(5);var invariant=__webpack_require__(10);var warning=__webpack_require__(11);var ExecutionEnvironment=__webpack_require__(36);var _assign=__webpack_require__(37);var emptyFunction=__webpack_require__(3);var EventListener=__webpack_require__(38);var getActiveElement=__webpack_require__(39);var shallowEqual=__webpack_require__(40);var containsNode=__webpack_require__(41);var focusNode=__webpack_require__(42);var emptyObject=__webpack_require__(6);var checkPropTypes=__webpack_require__(20);var hyphenateStyleName=__webpack_require__(88);var camelizeStyleName=__webpack_require__(90);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
...
if(false) {
	module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/cjs.js!./client.less", function() {
		var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/cjs.js!./client.less");
...
const React = __webpack_require__(5);
const remoteStateSocket = __webpack_require__(46);
...
class Booking extends React.Component {
  ...
  bookGame(event) {
    ...
    // Clean up
    const clean = value => {
      return value.split(',').map(Function.prototype.call, String.prototype.trim).map(Function.prototype.call, String.prototype.toLowerCase);
    };

    let team1 = clean(this.team1.value);
    let team2 = clean(this.team2.value);

    this.props.socket.emit('onBook', [team1, team2]);
  }
  ...
  render() {
    return React.createElement(
      'div',
      { className: 'container' },
      !this.props.game ? React.createElement(
        'div',
        null,
        React.createElement(
          'p',
        ...
        React.createElement(
          'form',
          { id: 'bookAGame', className: 'form-horizontal' },
          React.createElement(
            'div',
            { className: 'form-group' },
            React.createElement(
              'label',
              { htmlFor: 'team1', className: 'col-sm-3 control-label' },
              'Team #1'
            ),
            React.createElement(
              'div',
              { className: 'col-sm-9' },
              React.createElement('input', { className: 'form-control', name: 'team1', placeholder: 'Names', ref: input => {
                  this.team1 = input;
                } })
            )
          ),
          React.createElement(
            ...
            React.createElement(
              'label',
              { htmlFor: 'team2', className: 'col-sm-3 control-label' },
              'Team #2'
            ),
            React.createElement(
              'div',
              { className: 'col-sm-9' },
              React.createElement('input', { className: 'form-control', name: 'team2', placeholder: 'Names', ref: input => {
                  this.team2 = input;
                } })
            )
          ),
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'button',
                { className: 'btn btn-default', onClick: this.bookGame },
                'Book game'
              )
            )
          )
...
const { render } = __webpack_require__(83);
