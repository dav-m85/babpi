...
module.exports = {
  ...
  Blue: ({ children }) => React.createElement(
    'span',
    { className: 'blue' },
    children
  ),
...
class App extends React.Component {
  ...
  render() {
    ...
    let { game } = this.props;
    if (!game) {
      view = __webpack_require__(218);
    } else {
      switch (game.is) {
        case 'building':
          view = __webpack_require__(219);
          break;
        case 'booked':
          view = __webpack_require__(221);
          break;
        case 'playing':
          view = __webpack_require__(222);
          break;
        case 'win':
          view = __webpack_require__(223);
          break;
        default:
...
if(false) {
	module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/cjs.js!./scoreboard.less", function() {
		var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/cjs.js!./scoreboard.less");
...
module.exports = ({ players, options }) => {
  ...
  let foot = swap(options, React.createElement(
    Red,
    null,
    'foot'
  ), React.createElement(
